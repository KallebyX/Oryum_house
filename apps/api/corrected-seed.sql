-- Seed corrigido para Oryum House
...
-- Inserir condomínio
INSERT INTO condominiums (id, name, cnpj, address, settings, "logoUrl", "createdAt", "updatedAt") VALUES
('cond-001', 'Residencial Horizonte', '12.345.678/0001-90', '{"street": "Rua das Flores", "number": "123", "district": "Centro", "city": "Caçapava do Sul", "state": "RS", "cep": "96570-000"}', '{"theme": "blue", "timezone": "America/Sao_Paulo"}', NULL, NOW(), NOW());
